...
module.exports = {
    base: '/Oldmemorie.github.io/',//如果你准备发布到 https://<USERNAME>.github.io/<REPO>/ ，也就是说你的仓库地址是 https://github.com/<USERNAME>/<REPO> ，则将 base 设置为 "/<REPO>/"。
        ...
        * */
        [
            ...
            "vuepress-plugin-player",
            {
                ...
                //本地歌曲
                localSongs: {
                    coverUrl: '/Oldmemorie.jpg',
                    songs: [
                        {
                            path: '/song/Bande-annonce.mp3',
                            songName: 'Bande-annonce',
                        ...
                        {
                            path: '/song/Hanser - Cyberangel.flac',
                            songName: 'Hanser - Cyberangel'
                        },
                        {
                            path: '/song/HOYO-MiX - Circle of Life.flac',
                            songName: 'Circle of Life'
                        },
                        {
                            path: '/song/阿云嘎 HOYO-MiX - Regression.flac',
                            songName: '阿Regression'
                        },
                        {
                            path: '/song/周深 - Rubia.flac',
                            songName: 'Rubia'
                        },
                        {
                            path: '/song/幽栖 - Φ²（崩坏3「你我」pv曲）.flac',
                            songName: 'Φ²'
                        },
    ...
    * */
    themeConfig: {
        ...
        * */
        ...
        //网站开始时间，请按照以下格式进行
        startRunTime: "7/18/2023 00:00:00",
        ...
        homeWps: [
            "/bg/Real-ESRGANv3-anime_0729_110948.png",
            "/bg/3b84962b40a8f8670a8b701fe5d56bb5.png",
        ...
        * */
        ...
        //侧边栏一句话描述
        sidebarDesc: '一个人，要犯下多少恶行 才能在地狱的尽头，将她带回黎明。 一个人，要走多远的距离 才能在时光的尽头，追回最初的自己',
